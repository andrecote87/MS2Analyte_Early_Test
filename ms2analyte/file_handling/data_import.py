...
class DdaIndex:
    """Class for indexes od DDA to connect MS1 scan number to scan numbers and target masses of corresponding MS2 DDA
    scans and target masses for that MS1 scan
    """

    def __init__(self, current_ms1_scan, ms2_scan, selected_ion):
        self.current_ms1_scan = current_ms1_scan
        self.ms2_scan = ms2_scan
        self.selected_ion = selected_ion
...
def input_data_structure():
    ...
    # sample_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_func_test_replicates", "Samples")
    # blank_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_func_test_replicates", "Blanks")
    # output_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_func_test_replicates", "Output")
    # blanks_exist = False
    # replicate_count = 3
    # ms2_exists = True
    # ms2_type = "DIA"
    ...
    # ms_data_file_type = "func001"
    # ms_data_file_suffix = "csv"
    # experiment_name = "HDMSe_test"

    # sample_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_mzML_test", "Samples")
    # blank_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_mzML_test", "Blanks")
    # output_directory = os.path.join("/Users", "roger", "Git", "ms2analyte", "data", "test_input", "Waters_HDMSe_mzML_test", "Output")
    # blanks_exist = False
    # replicate_count = 1
    # ms2_exists = True
    # ms2_type = "DIA"
