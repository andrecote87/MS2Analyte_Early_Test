...
experiment_analyte_slope_r2_cuttoff = r-squared value to match peaks from analytes from different samples as the same
experiment analyte
...
experiment_analyte_slope_r2_cuttoff = 0.7